	...
	.equ KEY_4A, PWM_HZ / 440       @ 440Hz のときの1周期のクロック数 ra
	.equ KEY_5A, PWM_HZ / 880       @ 880Hz のときの1周期のクロック数 ra
	.equ GPIO_BASE,0x3f200000   	@ GPIOベースアドレス
	.equ GPFSEL0, 0x00   	    	@ GPIOポートの機能を選択する番地のオフセット
...
_start:
	...
	mov	r3, #0		@ 10の位
	@ GPIO #19 を出力用に設定
	ldr	r1, [r0, #(GPFSEL0 + PWM_PORT / 10 * 4)]
	orr     r1, #(1 << (3 * (PWM_PORT % 10) + 1))	@ +1を忘れずに！
